    ...
    function $olderPosts(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var childPageIndex32 = 0; childPageIndex32 < childPageListLen32; childPageIndex32++) {
        ...
        if (opt_data.page.url != childPageData32.url) {
          ...
          ie_open('a', null, null, 'class', 'post-item__link', 'href', childPageData32.url);
          ie_open('small');
          itext('By ');
...
(function () {
  ...
  var mainGuide = function (_Component) {
    babelHelpers.inherits(mainGuide, _Component);

    function mainGuide() {
      babelHelpers.classCallCheck(this, mainGuide);
      return babelHelpers.possibleConstructorReturn(this, (mainGuide.__proto__ || Object.getPrototypeOf(mainGuide)).apply(this, arguments));
    }
  ...
  this['metalNamed']['mainGuide'] = this['metalNamed']['mainGuide'] || {};
  this['metalNamed']['mainGuide']['mainGuide'] = mainGuide;
  this['metalNamed']['mainGuide']['templates'] = templates;
  this['metal']['mainGuide'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $logo(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_void('span', null, null, 'class', 'topbar-logo-icon icon-16-send');
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param106 = function param106() {
    ...
    function $header(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('a', null, null, 'href', 'https://github.com/ruyadorno/simple-slider', 'class', 'btn btn-accent');
      ie_void('span', null, null, 'class', 'icon-16-github');
      itext('See it on GitHub');
      ie_close('a');
      ie_open('a', null, null, 'href', 'https://gitter.im/simple-slider/Lobby', 'class', 'btn btn-default');
      ie_void('span', null, null, 'class', 'icon-16-balloon-topic');
      itext('Gitter chat');
      ie_close('a');
      ie_close('div');
      ie_close('div');
    ...
    function $why(opt_data, opt_ignored, opt_ijData) {
      ie_open('article', null, null, 'class', 'about', 'style', 'padding:0');
      ie_open('div', null, null, 'class', 'container');
      ie_open('div', null, null, 'id', 'home-simple-slider', 'class', 'simple-slider');
      ie_open('img', null, null, 'src', 'https://unsplash.it/900/400?random=1');
      ie_close('img');
      ie_open('img', null, null, 'src', 'https://unsplash.it/900/400?random=2');
      ie_close('img');
      ie_open('img', null, null, 'src', 'https://unsplash.it/900/400?random=3');
      ie_close('img');
      ie_open('img', null, null, 'src', 'https://unsplash.it/900/400?random=4');
      ie_close('img');
      ie_close('div');
      ie_close('div');
      ie_close('article');
    ...
    function $features(opt_data, opt_ignored, opt_ijData) {
      ...
      itext('Very small footprint at under 1.2kb gzipped and minified.');
      ie_close('p');
      ie_close('section');
      ...
      ie_open('p', null, null, 'class', 'feature-description');
      itext('Uses the ');
      ie_open('a', null, null, 'href', 'https://developer.mozilla.org/en-US/docs/Web/API/window/requestAnimationFrame');
      itext('requestAnimationFrame');
      ie_close('a');
      itext(' API to perform js animations for each transition, allowing to animate any numeric css property.');
      ie_close('p');
      ie_close('section');
      ie_open('section', null, null, 'class', 'feature col-md-4');
      ie_open('div', null, null, 'class', 'feature-graphic');
      ...
      ie_close('h3');
      ie_open('p', null, null, 'class', 'feature-description');
      itext('Distribution files have UMD support, allowing for usage along with RequireJS, webpack or just plain browser import.');
      ie_close('p');
      ie_close('section');
      ie_close('div');
      ie_close('div');
    ...
    function $how(opt_data, opt_ignored, opt_ijData) {
      ...
      itext('Just import the script and make a call to the initialization function!');
      ie_close('p');
      var param126 = function param126() {
        itext('<div style="width: 100%; padding-bottom: 25%" data-simple-slider>\n\t<img src="https://unsplash.it/640/160?random=1"/>\n\t<img src="https://unsplash.it/640/160?random=2"/>\n\t<img src="https://unsplash.it/640/160?random=3"/>\n</div>\n<script src="https://rawgit.com/ruyadorno/simple-slider/master/dist/simpleslider.min.js"></script>\n<script>\n\tsimpleslider.getSlider();\n</script>');
      };
      $templateAlias2({ code: param126, mode: 'text/html' }, null, opt_ijData);
      ie_open('p', null, null, 'class', 'about-description');
      itext('Many options can be used to help you customize your slider. Take a look at all the possible values in the ');
      ie_open('a', null, null, 'style', 'color:white', 'href', '/simple-slider/docs');
      itext('Docs');
      ie_close('a');
      itext(' or head to the ');
      ie_open('a', null, null, 'style', 'color: white', 'href', '/simple-slider/docs/examples');
      itext('Examples');
      ie_close('a');
      itext(' page to get some inspiration.');
      ie_close('p');
      ie_close('div');
      ie_close('div');
      ie_close('div');
    ...
    function $highlights(opt_data, opt_ignored, opt_ijData) {
      ...
      itext('Well documented');
      ie_close('h4');
      ie_open('p', null, null, 'class', 'highlight-description');
      itext('Extensive documentation on how to customize your slider and control it using an intuitive API.');
      ie_close('p');
      ie_open('p', null, null, 'class', 'highlight-description');
      itext('Tons of ready-to-use examples are also available.');
      ie_close('p');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
      ie_open('div', null, null, 'id', 'highlight1-simple-slider', 'class', 'highlight-slider simple-slider');
      ie_void('div', null, null, 'style', 'background-image:url(https://unsplash.it/500/400?random=1)');
      ie_void('div', null, null, 'style', 'background-image:url(https://unsplash.it/500/400?random=2)');
      ie_void('div', null, null, 'style', 'background-image:url(https://unsplash.it/500/400?random=3)');
      ie_close('div');
      ie_close('div');
      ie_close('section');
      ie_open('section', null, null, 'class', 'highlight row');
      ...
      ie_open('h4', null, null, 'class', 'highlight-title');
      itext('Can I just have an element?');
      ie_close('h4');
      ie_open('p', null, null, 'class', 'highlight-description');
      itext('Sure thing! There is an ');
      ie_open('a', null, null, 'href', 'https://www.npmjs.com/package/angular-simple-slider');
      itext('Angular directive');
      ie_close('a');
      itext(' and a ');
      ie_open('a', null, null, 'href', 'https://www.webcomponents.org/element/ruyadorno/polymer-simple-slider');
      itext('Web component');
      ie_close('a');
      itext(' implementation that just wraps this library into ready-to-use elements for these frameworks. Please visit their specific pages for more info on how to use those.');
      ie_close('p');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
      ie_open('div', null, null, 'id', 'highlight2-simple-slider', 'class', 'highlight-slider simple-slider');
      ie_open('img', null, null, 'src', 'https://unsplash.it/500/400?random=4');
      ie_close('img');
      ie_open('img', null, null, 'src', 'https://unsplash.it/500/400?random=5');
      ie_close('img');
      ie_close('div');
      ie_close('div');
      ie_close('section');
      ...
      ie_open('div', null, null, 'class', 'col-md-6 col-md-offset-2');
      ie_open('h4', null, null, 'class', 'highlight-title');
      itext('Free and Open Source');
      ie_close('h4');
      ie_open('p', null, null, 'class', 'highlight-description');
      itext('All the code is open source under the ');
      ie_open('a', null, null, 'href', 'https://github.com/ruyadorno/simple-slider/blob/master/LICENSE');
      itext('MIT license');
      ie_close('a');
      itext(' and free for any use.');
      ie_close('p');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
      ie_open('div', null, null, 'id', 'highlight3-simple-slider', 'class', 'highlight-slider simple-slider');
      ie_void('div', null, null, 'style', 'background-image:url(https://unsplash.it/500/400?random=6)');
      ie_void('div', null, null, 'style', 'background-image:url(https://unsplash.it/500/400?random=7)');
      ie_void('div', null, null, 'style', 'background-image:url(https://unsplash.it/500/400?random=8)');
      ie_close('div');
      ie_close('div');
      ie_close('section');
      ie_close('div');
    ...
    function $footer(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null, 'class', 'container');
      ie_open('div', null, null, 'class', 'row');
      ie_open('p', null, null, 'class', 'footer-description col-md-4 col-md-offset-2');
      itext('Copyright \xA9 2017 ');
      ie_open('a', null, null, 'href', 'http://ruyadorno.com');
      itext('Ruy Adorno');
      ie_close('a');
      ie_close('p');
      ie_open('p', null, null, 'class', 'footer-description col-md-4', 'style', 'text-align: center');
      ie_void('span', null, null, 'class', 'icon-16-github');
      itext(' ');
      ie_open('a', null, null, 'href', 'https://github.com/ruyadorno/simple-slider/');
      itext('GitHub repo');
      ie_close('a');
      ie_close('p');
      ie_open('p', null, null, 'class', 'footer-description col-md-4');
      itext('Powered by ');
      ie_open('a', null, null, 'href', 'http://electricjs.com/');
      itext('Electric');
      ie_close('a');
      ie_close('p');
      ie_close('div');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias1({ maxResults: 3, path: '/simple-slider/docs/', placeholder: 'Search Docs' }, null, opt_ijData);
      ie_close('div');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $topics(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('form', null, null, 'action', '/simple-slider/docs/search.html', 'method', 'GET', 'enctype', 'multipart/form-data');
      ie_open('div', null, null, 'class', 'row');
      ie_open('div', null, null, 'class', 'col-xs-14 col-xs-offset-1 col-md-10 col-md-offset-3 col-lg-6 col-lg-offset-5');
      ie_open('div', null, null, 'class', 'search');
      $templateAlias4({ maxResults: 3, path: '/simple-slider/docs/', placeholder: 'Search Docs' }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
      ie_close('div');
      ie_close('form');
      ...
      itext('The API section covers the available options and methods to customize the slider and the Examples are ready-to-use boilerplates to help you customize your animation.');
      ie_close('p');
      ie_close('section');
      ie_close('div');
      ie_close('div');
      ...
      ie_open('div', null, null, 'class', 'row');
      var topicList213 = opt_data.site.index.children[1].children;
      var topicListLen213 = topicList213.length;
      for (var topicIndex213 = 0; topicIndex213 < topicListLen213; topicIndex213++) {
        var topicData213 = topicList213[topicIndex213];
        if (!topicData213.hidden) {
          ie_open('div', null, null, 'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
          ie_open('a', null, null, 'class', 'topic radial-out', 'href', topicData213.url);
          ie_open('div', null, null, 'class', 'topic-icon');
          ie_void('span', null, null, 'class', 'icon-16-' + topicData213.icon);
          ie_close('div');
          ie_open('h3', null, null, 'class', 'topic-title');
          var dyn17 = topicData213.title;
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param219 = function param219() {
        ...
        ie_open('div', null, null, 'class', 'row');
        ie_open('div', null, null, 'class', 'container-hybrid');
        $templateAlias3({ action: '/simple-slider/docs/search.html', path: '/simple-slider/docs/', placeholder: 'Search Docs' }, null, opt_ijData);
        ie_close('div');
        ie_close('div');
        ie_close('div');
        ie_close('div');
      };
      $templateAlias1(soy.$$assignDefaults({ elementClasses: 'docs', content: param219 }, opt_data), null, opt_ijData);
    }
    exports.render = $render;
    if (goog.DEBUG) {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param245 = function param245() {
        ...
        ie_open('h2');
        itext('simpleslider.getSlider(options)');
        ie_close('h2');
        ie_open('p');
        ie_open('em');
        itext('AKA the initialization method.');
        ie_close('em');
        itext(' Creates a new ');
        ie_open('strong');
        itext('simple-slider');
        ie_close('strong');
        itext(' instance using the provided options, returns a ');
        ie_open('strong');
        itext('Slider');
        ie_close('strong');
        itext(' object.');
        ...
        itext('Usage example:');
        ie_close('p');
        $templateAlias2({ code: 'var slider = simpleslider.getSlider({\n    container: document.getElementById(\'mysliderid\')\n});', mode: 'javascript' }, null, opt_ijData);
        ie_open('p');
        itext('If options are omitted, their default value is used, here is a list with all the available options and their default values:');
        ie_close('p');
        ...
        ie_close('strong');
        itext(' <');
        ie_open('a', null, null, 'href', 'https://developer.mozilla.org/en-US/docs/Web/API/Element');
        itext('Element');
        ie_close('a');
        itext('> The HTML element that act as a container for the slider. Defaults to ');
        ie_open('code');
        itext('document.querySelector(\'*[data-simple-slider])');
        ie_close('code');
        itext('.');
        ie_close('p');
        ie_close('li');
        ...
        ie_close('strong');
        itext(' <');
        ie_open('a', null, null, 'href', 'https://developer.mozilla.org/en-US/docs/Web/API/NodeList');
        itext('NodeList');
        ie_close('a');
        itext('/Array> A list of children to be used as slides, you can use the ');
        ie_open('a', null, null, 'href', 'https://developer.mozilla.org/en-US/docs/Web/API/Document/querySelectorAll');
        itext('querySelectorAll');
        ie_close('a');
        itext(' to have more flexibility on what children of the ');
        ie_open('code');
        itext('container');
        ie_close('code');
        itext(' element should be used as slides. Defaults to ');
        ie_open('code');
        itext('container.children');
        ie_close('code');
        itext('.');
        ie_close('p');
        ie_close('li');
        ...
        itext('paused');
        ie_close('strong');
        itext(' <Boolean> Controls carousel auto-transition/slideshow. If value is ');
        ie_open('code');
        itext('true');
        ie_close('code');
        itext(' no transition will happen. Defaults to ');
        ie_open('code');
        itext('false');
        ie_close('code');
        itext('.');
        ...
        itext('prop');
        ie_close('strong');
        itext(' <String> Determines the css property to be animated. Defaults to ');
        ie_open('code');
        itext('left');
        ie_close('code');
        itext('.');
        ...
        itext('duration');
        ie_close('strong');
        itext(' <Number> Value setting the duration of animation transition. Defaults to ');
        ie_open('code');
        itext('0.5');
        ie_close('code');
        itext('.');
        ...
        itext('delay');
        ie_close('strong');
        itext(' <Number> Value determining the wait between each animation when auto-transition is enabled. Defaults to ');
        ie_open('code');
        itext('3');
        ie_close('code');
        itext(' seconds.');
        ...
        itext('init');
        ie_close('strong');
        itext(' <String/Number> Initial value of slide elements when starting a transition animation. Defaults to ');
        ie_open('code');
        itext('-100');
        ie_close('code');
        itext('.');
        ...
        itext('show');
        ie_close('strong');
        itext(' <String/Number> The value a slide element should have when it is displayed. Defaults to ');
        ie_open('code');
        itext('0');
        ie_close('code');
        itext('.');
        ...
        itext('end');
        ie_close('strong');
        itext(' <String/Number> The value a slide will move to during a transition animation. Defaults to ');
        ie_open('code');
        itext('100');
        ie_close('code');
        itext('.');
        ...
        itext('unit');
        ie_close('strong');
        itext(' <String> The css unit value to be used. Defaults to ');
        ie_open('code');
        itext('%');
        ie_close('code');
        itext('.');
        ...
        itext('ease');
        ie_close('strong');
        itext(' <Function> An ease function, you can use any of ');
        ie_open('a', null, null, 'href', 'https://github.com/jimjeffers/Easie/blob/master/easie.js');
        itext('these');
        ie_close('a');
        itext('. Defaults to ');
        ie_open('code');
        itext('defaultEase');
        ie_close('code');
        itext(' internal function.');
        ie_close('p');
        ie_close('li');
        ie_open('li');
        ie_open('p');
        ie_open('strong');
        itext('onChange(prevIndex, nextIndex)');
        ie_close('strong');
        itext(' <Function> A callback function to be defined by the user. This function will be called everytime a slide changes and will contain two arguments, the first one is the index value of the previous active slide and the second is the index value of the next slide to be inserted.');
        ie_close('p');
        ie_close('li');
        ie_open('li');
        ie_open('p');
        ie_open('strong');
        itext('onChangeEnd(prevIndex, nextIndex)');
        ie_close('strong');
        itext(' <Function> A callback function to be defined by the user. Called everytime the animation transition is completed, it has the current displaying slide index value and the next slide index value passed as parameters.');
        ie_close('p');
        ie_close('li');
        ie_close('ul');
        ie_close('article');
        ...
        itext('Slider');
        ie_close('strong');
        itext(' object is returned when a new slider is created using ');
        ie_open('code');
        itext('simpleslider.getSlider()');
        ie_close('code');
        itext(' it exposes many methods that allow you to control it. Here you can see a list with all methods available, further bellow follows a description of each method.');
        ie_close('p');
        $templateAlias2({ code: 'Slider {\n    currentIndex()\n    pause()\n    resume()\n    reverse()\n    nextIndex()\n    prevIndex()\n    next()\n    prev()\n    change(index)\n    dispose()\n}', mode: 'javascript' }, null, opt_ijData);
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        itext('currentIndex()');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Retrieves the index of the current displaying slide.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Pauses the slider slideshow.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Resumes the slider slideshow.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Swaps the values of the ');
        ie_open('code');
        itext('init');
        ie_close('code');
        itext(' property with the one from ');
        ie_open('code');
        itext('end');
        ie_close('code');
        itext(' and also reverses the order of slides.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Gets the index of the next slide to be shown.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Gets the index of the previous slide.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Perform the remove animation of the actual displaying slide and insert the next one from the slide list.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Perform the remove animation of the actual displaying slide and insert the previous one from the slide list.');
        ie_close('p');
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        itext('change(index <Number>)');
        ie_close('strong');
        ie_close('li');
        ie_close('ul');
        ie_open('p');
        itext('Change displaying slides, it will perform the remove animation of the actual displaying slide and insert the slide that corresponds to the provided index value.');
        ie_close('p');
        $templateAlias2({ code: 'var slider = simpleslider.getSlider();\n\n// Jumps to third slide:\nslider.change(2);', mode: 'javascript' }, null, opt_ijData);
        ie_open('ul');
        ie_open('li');
        ie_open('strong');
        itext('dispose()');
        ...
        ie_close('ul');
        ie_open('p');
        itext('Disposes of all internal variable references.');
        ie_close('p');
        $templateAlias2({ code: 'var slider = simpleslider.getSlider();\n\n// Free memory used by slider\nslider.dispose();', mode: 'javascript' }, null, opt_ijData);
        ie_close('article');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.page.title);
        ie_close('input');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.site.title);
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from custom-ease-animation-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesCustomEaseAnimationExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesCustomEaseAnimationExampleDocsHtml.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesCustomEaseAnimationExampleDocsHtml.render';
    }
  ...
  var docsExamplesCustomEaseAnimationExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesCustomEaseAnimationExampleDocsHtml, _Component);

    function docsExamplesCustomEaseAnimationExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesCustomEaseAnimationExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesCustomEaseAnimationExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesCustomEaseAnimationExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesCustomEaseAnimationExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesCustomEaseAnimationExampleDocsHtml, templates);
  this['metalNamed']['custom-ease-animation-example-docs'] = this['metalNamed']['custom-ease-animation-example-docs'] || {};
  this['metalNamed']['custom-ease-animation-example-docs']['docsExamplesCustomEaseAnimationExampleDocsHtml'] = docsExamplesCustomEaseAnimationExampleDocsHtml;
  this['metalNamed']['custom-ease-animation-example-docs']['templates'] = templates;
  this['metal']['custom-ease-animation-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from default-sliding-transition-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesDefaultSlidingTransitionDocsHtml.
     * @public
     */

    goog.module('docsExamplesDefaultSlidingTransitionDocsHtml.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesDefaultSlidingTransitionDocsHtml.render';
    }
  ...
  var docsExamplesDefaultSlidingTransitionDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesDefaultSlidingTransitionDocsHtml, _Component);

    function docsExamplesDefaultSlidingTransitionDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesDefaultSlidingTransitionDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesDefaultSlidingTransitionDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesDefaultSlidingTransitionDocsHtml)).apply(this, arguments));
    }

    return docsExamplesDefaultSlidingTransitionDocsHtml;
  }(Component);

  Soy.register(docsExamplesDefaultSlidingTransitionDocsHtml, templates);
  this['metalNamed']['default-sliding-transition-docs'] = this['metalNamed']['default-sliding-transition-docs'] || {};
  this['metalNamed']['default-sliding-transition-docs']['docsExamplesDefaultSlidingTransitionDocsHtml'] = docsExamplesDefaultSlidingTransitionDocsHtml;
  this['metalNamed']['default-sliding-transition-docs']['templates'] = templates;
  this['metal']['default-sliding-transition-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    /**
     * @fileoverview Templates in namespace docsExamples.
     * @public
     */

    goog.module('docsExamples.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param345 = function param345() {
        ...
        ie_open('ul');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/responsive-layout-example-docs.html');
        itext('Responsive layout example');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/no-options-docs.html');
        itext('Default slider with no options');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/default-sliding-transition-docs.html');
        itext('Default slider with options');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/fading-transition-docs.html');
        itext('Fading/Opacity transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/full-page-transition-docs.html');
        itext('Full page transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/lightbox-integrated-example-docs.html');
        itext('Lightbox integrated');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/mask-sliding-transition-docs.html');
        itext('Mask sliding transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/pause-slide-change-example-docs.html');
        itext('Pause slide');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/requirejs-example-docs.html');
        itext('RequireJS usage');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/reverse-sliding-direction-example-docs.html');
        itext('Reverse sliding direction');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/right-to-left-sliding-transition-docs.html');
        itext('Right to left sliding transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/text-content-example-docs.html');
        itext('Slides containing no images');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/top-to-bottom-sliding-transition-docs.html');
        itext('Top to bottom transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/touch-swipe-example-docs.html');
        itext('Touch swipe example');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/simple-slider/docs/examples/custom-ease-animation-example-docs.html');
        itext('Custom ease animation');
        ie_close('a');
        ie_close('li');
        ie_close('ul');
        ie_close('article');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamples.render';
    }
  ...
  var docsExamples = function (_Component) {
    babelHelpers.inherits(docsExamples, _Component);

    function docsExamples() {
      babelHelpers.classCallCheck(this, docsExamples);
      return babelHelpers.possibleConstructorReturn(this, (docsExamples.__proto__ || Object.getPrototypeOf(docsExamples)).apply(this, arguments));
    }

    return docsExamples;
  }(Component);

  Soy.register(docsExamples, templates);
  this['metalNamed']['index'] = this['metalNamed']['index'] || {};
  this['metalNamed']['index']['docsExamples'] = docsExamples;
  this['metalNamed']['index']['templates'] = templates;
  this['metal']['index'] = templates;
  /* jshint ignore:end */
}).call(this);
...
(function () {
  ...
  this['metal']['docsExamples'] = docsExamples;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['custom-ease-animation-example-docs'];
  ...
  this['metal']['docsExamplesCustomEaseAnimationExampleDocsHtml'] = docsExamplesCustomEaseAnimationExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['default-sliding-transition-docs'];
  ...
  this['metal']['docsExamplesDefaultSlidingTransitionDocsHtml'] = docsExamplesDefaultSlidingTransitionDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from fading-transition-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesFadingTransitionDocsHtml.
     * @public
     */

    goog.module('docsExamplesFadingTransitionDocsHtml.incrementaldom');
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param313 = function param313() {
        ie_open('h6');
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './fading-transition.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesFadingTransitionDocsHtml.render';
    }
  ...
  var docsExamplesFadingTransitionDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesFadingTransitionDocsHtml, _Component);

    function docsExamplesFadingTransitionDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesFadingTransitionDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesFadingTransitionDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesFadingTransitionDocsHtml)).apply(this, arguments));
    }

    return docsExamplesFadingTransitionDocsHtml;
  }(Component);

  Soy.register(docsExamplesFadingTransitionDocsHtml, templates);
  this['metalNamed']['fading-transition-docs'] = this['metalNamed']['fading-transition-docs'] || {};
  this['metalNamed']['fading-transition-docs']['docsExamplesFadingTransitionDocsHtml'] = docsExamplesFadingTransitionDocsHtml;
  this['metalNamed']['fading-transition-docs']['templates'] = templates;
  this['metal']['fading-transition-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['fading-transition-docs'];
  ...
  this['metal']['docsExamplesFadingTransitionDocsHtml'] = docsExamplesFadingTransitionDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from full-page-transition-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesFullPageTransitionDocsHtml.
     * @public
     */

    goog.module('docsExamplesFullPageTransitionDocsHtml.incrementaldom');
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param329 = function param329() {
        ie_open('h6');
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './full-page-transition.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
        $templateAlias2({ code: '<!doctype html>\n<html>\n  <head>\n    <title>Slider occupying full page</title>\n    <style>\n      html body { margin: 0; padding: 0; }\n      #myslider { width:100%; }\n      #myslider img { width:100%; height:auto; }\n    </style>\n  </head>\n  <body>\n    <div id="myslider">\n      <img src="http://placekitten.com/g/612/612"/>\n      <img src="https://unsplash.it/612/612"/>\n      <img src="https://unsplash.it/612/612?random=1"/>\n      <img src="https://unsplash.it/612/612?random=2"/>\n    </div>\n  </body>\n  <script src="../dist/simpleslider.js"><\/script>\n  <script>\n    var container = document.getElementById(\'myslider\');\n    var height = isNaN(window.innerHeight) ? window.clientHeight : window.innerHeight;\n    var imgSlider = simpleslider.getSlider({\n      container: container,\n      autoPlay: true,\n      prop: \'left\',\n      unit: \'%\',\n      init: -100,\n      show: 0,\n      end: 100\n    });\n    container.style.height = height + \'px\';\n  <\/script>\n</html>', mode: 'text/html' }, null, opt_ijData);
        ie_close('article');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.page.title);
        ie_close('input');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.site.title);
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesFullPageTransitionDocsHtml.render';
    }
  ...
  var docsExamplesFullPageTransitionDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesFullPageTransitionDocsHtml, _Component);

    function docsExamplesFullPageTransitionDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesFullPageTransitionDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesFullPageTransitionDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesFullPageTransitionDocsHtml)).apply(this, arguments));
    }

    return docsExamplesFullPageTransitionDocsHtml;
  }(Component);

  Soy.register(docsExamplesFullPageTransitionDocsHtml, templates);
  this['metalNamed']['full-page-transition-docs'] = this['metalNamed']['full-page-transition-docs'] || {};
  this['metalNamed']['full-page-transition-docs']['docsExamplesFullPageTransitionDocsHtml'] = docsExamplesFullPageTransitionDocsHtml;
  this['metalNamed']['full-page-transition-docs']['templates'] = templates;
  this['metal']['full-page-transition-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['full-page-transition-docs'];
  ...
  this['metal']['docsExamplesFullPageTransitionDocsHtml'] = docsExamplesFullPageTransitionDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from lightbox-integrated-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesLightboxIntegratedExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesLightboxIntegratedExampleDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param356 = function param356() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './lightbox-integrated-example.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesLightboxIntegratedExampleDocsHtml.render';
    }
  ...
  var docsExamplesLightboxIntegratedExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesLightboxIntegratedExampleDocsHtml, _Component);

    function docsExamplesLightboxIntegratedExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesLightboxIntegratedExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesLightboxIntegratedExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesLightboxIntegratedExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesLightboxIntegratedExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesLightboxIntegratedExampleDocsHtml, templates);
  this['metalNamed']['lightbox-integrated-example-docs'] = this['metalNamed']['lightbox-integrated-example-docs'] || {};
  this['metalNamed']['lightbox-integrated-example-docs']['docsExamplesLightboxIntegratedExampleDocsHtml'] = docsExamplesLightboxIntegratedExampleDocsHtml;
  this['metalNamed']['lightbox-integrated-example-docs']['templates'] = templates;
  this['metal']['lightbox-integrated-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['lightbox-integrated-example-docs'];
  ...
  this['metal']['docsExamplesLightboxIntegratedExampleDocsHtml'] = docsExamplesLightboxIntegratedExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from mask-sliding-transition-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesMaskSlidingTransitionDocsHtml.
     * @public
     */

    goog.module('docsExamplesMaskSlidingTransitionDocsHtml.incrementaldom');
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param372 = function param372() {
        ie_open('h6');
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './mask-sliding-transition.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
        $templateAlias2({ code: '<!doctype html>\n<html>\n  <head>\n    <title>Mask sliding example</title>\n    <style>\n      #myslider, #myslider div{ width:612px; height:612px; }\n    </style>\n  </head>\n  <body>\n    <div id="myslider">\n      <div style="background-image:url(http://placekitten.com/g/612/612)"></div>\n      <div style="background-image:url(https://unsplash.it/612/612)"></div>\n      <div style="background-image:url(https://unsplash.it/612/612?random=1)"></div>\n      <div style="background-image:url(https://unsplash.it/612/612?random=2)"></div>\n    </div>\n  </body>\n  <script src="../dist/simpleslider.js"><\/script>\n  <script>\n    var imgSlider = simpleslider.getSlider({\n      container: document.getElementById(\'myslider\'),\n      prop: \'width\',\n      init: 0,\n      show: 612,\n      end: 612,\n      unit: \'px\'\n    });\n  <\/script>\n</html>', mode: 'text/html' }, null, opt_ijData);
        ie_close('article');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.page.title);
        ie_close('input');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.site.title);
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesMaskSlidingTransitionDocsHtml.render';
    }
  ...
  var docsExamplesMaskSlidingTransitionDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesMaskSlidingTransitionDocsHtml, _Component);

    function docsExamplesMaskSlidingTransitionDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesMaskSlidingTransitionDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesMaskSlidingTransitionDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesMaskSlidingTransitionDocsHtml)).apply(this, arguments));
    }

    return docsExamplesMaskSlidingTransitionDocsHtml;
  }(Component);

  Soy.register(docsExamplesMaskSlidingTransitionDocsHtml, templates);
  this['metalNamed']['mask-sliding-transition-docs'] = this['metalNamed']['mask-sliding-transition-docs'] || {};
  this['metalNamed']['mask-sliding-transition-docs']['docsExamplesMaskSlidingTransitionDocsHtml'] = docsExamplesMaskSlidingTransitionDocsHtml;
  this['metalNamed']['mask-sliding-transition-docs']['templates'] = templates;
  this['metal']['mask-sliding-transition-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['mask-sliding-transition-docs'];
  ...
  this['metal']['docsExamplesMaskSlidingTransitionDocsHtml'] = docsExamplesMaskSlidingTransitionDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from no-options-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesNoOptionsDocsHtml.
     * @public
     */

    goog.module('docsExamplesNoOptionsDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param388 = function param388() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './no-options.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesNoOptionsDocsHtml.render';
    }
  ...
  var docsExamplesNoOptionsDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesNoOptionsDocsHtml, _Component);

    function docsExamplesNoOptionsDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesNoOptionsDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesNoOptionsDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesNoOptionsDocsHtml)).apply(this, arguments));
    }

    return docsExamplesNoOptionsDocsHtml;
  }(Component);

  Soy.register(docsExamplesNoOptionsDocsHtml, templates);
  this['metalNamed']['no-options-docs'] = this['metalNamed']['no-options-docs'] || {};
  this['metalNamed']['no-options-docs']['docsExamplesNoOptionsDocsHtml'] = docsExamplesNoOptionsDocsHtml;
  this['metalNamed']['no-options-docs']['templates'] = templates;
  this['metal']['no-options-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['no-options-docs'];
  ...
  this['metal']['docsExamplesNoOptionsDocsHtml'] = docsExamplesNoOptionsDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from pause-slide-change-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesPauseSlideChangeExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesPauseSlideChangeExampleDocsHtml.incrementaldom');
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param404 = function param404() {
        ie_open('h6');
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './pause-slide-change-example.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesPauseSlideChangeExampleDocsHtml.render';
    }
  ...
  var docsExamplesPauseSlideChangeExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesPauseSlideChangeExampleDocsHtml, _Component);

    function docsExamplesPauseSlideChangeExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesPauseSlideChangeExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesPauseSlideChangeExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesPauseSlideChangeExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesPauseSlideChangeExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesPauseSlideChangeExampleDocsHtml, templates);
  this['metalNamed']['pause-slide-change-example-docs'] = this['metalNamed']['pause-slide-change-example-docs'] || {};
  this['metalNamed']['pause-slide-change-example-docs']['docsExamplesPauseSlideChangeExampleDocsHtml'] = docsExamplesPauseSlideChangeExampleDocsHtml;
  this['metalNamed']['pause-slide-change-example-docs']['templates'] = templates;
  this['metal']['pause-slide-change-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['pause-slide-change-example-docs'];
  ...
  this['metal']['docsExamplesPauseSlideChangeExampleDocsHtml'] = docsExamplesPauseSlideChangeExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from requirejs-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesRequirejsExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesRequirejsExampleDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param420 = function param420() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './requirejs-example.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
        $templateAlias2({ code: '<!doctype html>\n<html>\n  <head>\n    <title>RequireJS example</title>\n    <style>\n      #myslider { width:612px; height:612px; }\n    </style>\n  </head>\n  <body>\n    <div id="myslider">\n      <img src="http://placekitten.com/g/612/612"/>\n      <img src="https://unsplash.it/612/612"/>\n      <img src="https://unsplash.it/612/612?random=1"/>\n      <img src="https://unsplash.it/612/612?random=2"/>\n    </div>\n    <script src="http://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"><\/script>\n    <script>\n      require(["../dist/simpleslider"], function(simpleSlider) {\n        simpleSlider.getSlider({\n          container: document.getElementById(\'myslider\')\n        });\n      });\n    <\/script>\n  </body>\n</html>', mode: 'text/html' }, null, opt_ijData);
        ie_close('article');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.page.title);
        ie_close('input');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.site.title);
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesRequirejsExampleDocsHtml.render';
    }
  ...
  var docsExamplesRequirejsExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesRequirejsExampleDocsHtml, _Component);

    function docsExamplesRequirejsExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesRequirejsExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesRequirejsExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesRequirejsExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesRequirejsExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesRequirejsExampleDocsHtml, templates);
  this['metalNamed']['requirejs-example-docs'] = this['metalNamed']['requirejs-example-docs'] || {};
  this['metalNamed']['requirejs-example-docs']['docsExamplesRequirejsExampleDocsHtml'] = docsExamplesRequirejsExampleDocsHtml;
  this['metalNamed']['requirejs-example-docs']['templates'] = templates;
  this['metal']['requirejs-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['requirejs-example-docs'];
  ...
  this['metal']['docsExamplesRequirejsExampleDocsHtml'] = docsExamplesRequirejsExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from responsive-layout-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesResponsiveLayoutExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesResponsiveLayoutExampleDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param436 = function param436() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './responsive-layout-example.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesResponsiveLayoutExampleDocsHtml.render';
    }
  ...
  var docsExamplesResponsiveLayoutExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesResponsiveLayoutExampleDocsHtml, _Component);

    function docsExamplesResponsiveLayoutExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesResponsiveLayoutExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesResponsiveLayoutExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesResponsiveLayoutExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesResponsiveLayoutExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesResponsiveLayoutExampleDocsHtml, templates);
  this['metalNamed']['responsive-layout-example-docs'] = this['metalNamed']['responsive-layout-example-docs'] || {};
  this['metalNamed']['responsive-layout-example-docs']['docsExamplesResponsiveLayoutExampleDocsHtml'] = docsExamplesResponsiveLayoutExampleDocsHtml;
  this['metalNamed']['responsive-layout-example-docs']['templates'] = templates;
  this['metal']['responsive-layout-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['responsive-layout-example-docs'];
  ...
  this['metal']['docsExamplesResponsiveLayoutExampleDocsHtml'] = docsExamplesResponsiveLayoutExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from reverse-sliding-direction-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesReverseSlidingDirectionExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesReverseSlidingDirectionExampleDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param452 = function param452() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './reverse-sliding-direction-example.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesReverseSlidingDirectionExampleDocsHtml.render';
    }
  ...
  var docsExamplesReverseSlidingDirectionExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesReverseSlidingDirectionExampleDocsHtml, _Component);

    function docsExamplesReverseSlidingDirectionExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesReverseSlidingDirectionExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesReverseSlidingDirectionExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesReverseSlidingDirectionExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesReverseSlidingDirectionExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesReverseSlidingDirectionExampleDocsHtml, templates);
  this['metalNamed']['reverse-sliding-direction-example-docs'] = this['metalNamed']['reverse-sliding-direction-example-docs'] || {};
  this['metalNamed']['reverse-sliding-direction-example-docs']['docsExamplesReverseSlidingDirectionExampleDocsHtml'] = docsExamplesReverseSlidingDirectionExampleDocsHtml;
  this['metalNamed']['reverse-sliding-direction-example-docs']['templates'] = templates;
  this['metal']['reverse-sliding-direction-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['reverse-sliding-direction-example-docs'];
  ...
  this['metal']['docsExamplesReverseSlidingDirectionExampleDocsHtml'] = docsExamplesReverseSlidingDirectionExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from right-to-left-sliding-transition-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesRightToLeftSlidingTransitionDocsHtml.
     * @public
     */

    goog.module('docsExamplesRightToLeftSlidingTransitionDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param468 = function param468() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './right-to-left-sliding-transition.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
        $templateAlias2({ code: '<!doctype html>\n<html>\n  <head>\n    <title>An example with images sliding from right to left</title>\n    <style>\n      #myslider { width:612px; height:612px; }\n    </style>\n  </head>\n  <body>\n    <div id="myslider">\n      <img src="http://placekitten.com/g/612/612"/>\n      <img src="https://unsplash.it/612/612"/>\n      <img src="https://unsplash.it/612/612?random=1"/>\n      <img src="https://unsplash.it/612/612?random=2"/>\n    </div>\n  </body>\n  <script src="../dist/simpleslider.js"><\/script>\n  <script>\n    var imgSlider = simpleslider.getSlider({\n      container: document.getElementById(\'myslider\'),\n      prop: \'left\',\n      init: 612,\n      show: 0,\n      end: -612,\n      unit: \'px\',\n      delay: 2,\n      duration: 1\n    });\n  <\/script>\n</html>', mode: 'text/html' }, null, opt_ijData);
        ie_close('article');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.page.title);
        ie_close('input');
        ie_open('input', null, null, 'type', 'hidden', 'value', opt_data.site.title);
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesRightToLeftSlidingTransitionDocsHtml.render';
    }
  ...
  var docsExamplesRightToLeftSlidingTransitionDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesRightToLeftSlidingTransitionDocsHtml, _Component);

    function docsExamplesRightToLeftSlidingTransitionDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesRightToLeftSlidingTransitionDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesRightToLeftSlidingTransitionDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesRightToLeftSlidingTransitionDocsHtml)).apply(this, arguments));
    }

    return docsExamplesRightToLeftSlidingTransitionDocsHtml;
  }(Component);

  Soy.register(docsExamplesRightToLeftSlidingTransitionDocsHtml, templates);
  this['metalNamed']['right-to-left-sliding-transition-docs'] = this['metalNamed']['right-to-left-sliding-transition-docs'] || {};
  this['metalNamed']['right-to-left-sliding-transition-docs']['docsExamplesRightToLeftSlidingTransitionDocsHtml'] = docsExamplesRightToLeftSlidingTransitionDocsHtml;
  this['metalNamed']['right-to-left-sliding-transition-docs']['templates'] = templates;
  this['metal']['right-to-left-sliding-transition-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['right-to-left-sliding-transition-docs'];
  ...
  this['metal']['docsExamplesRightToLeftSlidingTransitionDocsHtml'] = docsExamplesRightToLeftSlidingTransitionDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from text-content-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesTextContentExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesTextContentExampleDocsHtml.incrementaldom');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesTextContentExampleDocsHtml.render';
    }
  ...
  var docsExamplesTextContentExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesTextContentExampleDocsHtml, _Component);

    function docsExamplesTextContentExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesTextContentExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesTextContentExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesTextContentExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesTextContentExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesTextContentExampleDocsHtml, templates);
  this['metalNamed']['text-content-example-docs'] = this['metalNamed']['text-content-example-docs'] || {};
  this['metalNamed']['text-content-example-docs']['docsExamplesTextContentExampleDocsHtml'] = docsExamplesTextContentExampleDocsHtml;
  this['metalNamed']['text-content-example-docs']['templates'] = templates;
  this['metal']['text-content-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['text-content-example-docs'];
  ...
  this['metal']['docsExamplesTextContentExampleDocsHtml'] = docsExamplesTextContentExampleDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from top-to-bottom-slide-transition-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesTopToBottomSlideTransitionDocsHtml.
     * @public
     */

    goog.module('docsExamplesTopToBottomSlideTransitionDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param500 = function param500() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './top-to-bottom-slide-transition.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesTopToBottomSlideTransitionDocsHtml.render';
    }
  ...
  var docsExamplesTopToBottomSlideTransitionDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesTopToBottomSlideTransitionDocsHtml, _Component);

    function docsExamplesTopToBottomSlideTransitionDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesTopToBottomSlideTransitionDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesTopToBottomSlideTransitionDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesTopToBottomSlideTransitionDocsHtml)).apply(this, arguments));
    }

    return docsExamplesTopToBottomSlideTransitionDocsHtml;
  }(Component);

  Soy.register(docsExamplesTopToBottomSlideTransitionDocsHtml, templates);
  this['metalNamed']['top-to-bottom-slide-transition-docs'] = this['metalNamed']['top-to-bottom-slide-transition-docs'] || {};
  this['metalNamed']['top-to-bottom-slide-transition-docs']['docsExamplesTopToBottomSlideTransitionDocsHtml'] = docsExamplesTopToBottomSlideTransitionDocsHtml;
  this['metalNamed']['top-to-bottom-slide-transition-docs']['templates'] = templates;
  this['metal']['top-to-bottom-slide-transition-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['top-to-bottom-slide-transition-docs'];
  ...
  this['metal']['docsExamplesTopToBottomSlideTransitionDocsHtml'] = docsExamplesTopToBottomSlideTransitionDocsHtml;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    // This file was automatically generated from touch-swipe-example-docs.soy.
    // Please don't edit this file by hand.

    /**
     * @fileoverview Templates in namespace docsExamplesTouchSwipeExampleDocsHtml.
     * @public
     */

    goog.module('docsExamplesTouchSwipeExampleDocsHtml.incrementaldom');
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param516 = function param516() {
        ...
        ie_open('article', null, null, 'id', 'base');
        ie_open('h2');
        ie_open('a', null, null, 'href', './touch-swipe-example.html');
        itext('View this example');
        ie_close('a');
        ie_close('h2');
    ...
    exports.render = $render;
    if (goog.DEBUG) {
      $render.soyTemplateName = 'docsExamplesTouchSwipeExampleDocsHtml.render';
    }
  ...
  var docsExamplesTouchSwipeExampleDocsHtml = function (_Component) {
    babelHelpers.inherits(docsExamplesTouchSwipeExampleDocsHtml, _Component);

    function docsExamplesTouchSwipeExampleDocsHtml() {
      babelHelpers.classCallCheck(this, docsExamplesTouchSwipeExampleDocsHtml);
      return babelHelpers.possibleConstructorReturn(this, (docsExamplesTouchSwipeExampleDocsHtml.__proto__ || Object.getPrototypeOf(docsExamplesTouchSwipeExampleDocsHtml)).apply(this, arguments));
    }

    return docsExamplesTouchSwipeExampleDocsHtml;
  }(Component);

  Soy.register(docsExamplesTouchSwipeExampleDocsHtml, templates);
  this['metalNamed']['touch-swipe-example-docs'] = this['metalNamed']['touch-swipe-example-docs'] || {};
  this['metalNamed']['touch-swipe-example-docs']['docsExamplesTouchSwipeExampleDocsHtml'] = docsExamplesTouchSwipeExampleDocsHtml;
  this['metalNamed']['touch-swipe-example-docs']['templates'] = templates;
  this['metal']['touch-swipe-example-docs'] = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  var Component = this['metal']['component'];
  var Soy = this['metal']['Soy'];
  var templates = this['metal']['touch-swipe-example-docs'];
  ...
  this['metal']['docsExamplesTouchSwipeExampleDocsHtml'] = docsExamplesTouchSwipeExampleDocsHtml;
}).call(this);
}).call(this);
