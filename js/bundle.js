...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $how(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('a', null, null, 'style', 'color:white', 'href', '/docs');
      itext('Docs');
      ie_close('a');
      itext(' or head to the ');
      ie_open('a', null, null, 'style', 'color: white', 'href', '/docs/examples');
      itext('Examples');
      ie_close('a');
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var param345 = function param345() {
        ...
        ie_open('ul');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/responsive-layout-example-docs.html');
        itext('Responsive layout example');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/no-options-docs.html');
        itext('Default slider with no options');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/default-sliding-transition-docs.html');
        itext('Default slider with options');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/fading-transition-docs.html');
        itext('Fading/Opacity transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/full-page-transition-docs.html');
        itext('Full page transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/lightbox-integrated-example-docs.html');
        itext('Lightbox integrated');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/mask-sliding-transition-docs.html');
        itext('Mask sliding transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/pause-slide-change-example-docs.html');
        itext('Pause slide');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/requirejs-example-docs.html');
        itext('RequireJS usage');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/reverse-sliding-direction-example-docs.html');
        itext('Reverse sliding direction');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/right-to-left-sliding-transition-docs.html');
        itext('Right to left sliding transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/text-content-example-docs.html');
        itext('Slides containing no images');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/top-to-bottom-sliding-transition-docs.html');
        itext('Top to bottom transition');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/touch-swipe-example-docs.html');
        itext('Touch swipe example');
        ie_close('a');
        ie_close('li');
        ie_open('li');
        ie_open('a', null, null, 'href', '/docs/examples/custom-ease-animation-example-docs.html');
